...
write.csv(pred_vs_ref_rpart,"D:/Drive_C_2_18_21/PhD_WORK/Chapter_1/South_eastern_perennial/Gini/Modelling/Rpart/pred_vs_ref.csv")
...
write.csv(per_class_metrics_rpart,"D:/Drive_C_2_18_21/PhD_WORK/Chapter_1/South_eastern_perennial/Gini/Modelling/Rpart/per_class_metrics_rpart.csv")
...
write.csv(Macro_averaged_metrics_tree,"D:/Drive_C_2_18_21/PhD_WORK/Chapter_1/South_eastern_perennial/Gini/Modelling/Rpart/macro_averaged_metric_tree.csv")
...
write.csv(pred_vs_ref_rpart_pruned,"D:/Drive_C_2_18_21/PhD_WORK/Chapter_1/South_eastern_perennial/Gini/Modelling/Rpart/pred_vs_ref_pruned.csv")
...
write.csv(per_class_metrics_rpart_pruned,"D:/Drive_C_2_18_21/PhD_WORK/Chapter_1/South_eastern_perennial/Gini/Modelling/Rpart/per_class_metrics_rpart_pruned.csv")
...
write.csv(Macro_averaged_metrics_tree_pruned,"D:/Drive_C_2_18_21/PhD_WORK/Chapter_1/South_eastern_perennial/Boruta/Modelling/Rpart/macro_averaged_metric_tree_pruned.csv")
...
write.csv(pred_vs_ref_rpart,"D:/Drive_C_2_18_21/PhD_WORK/Chapter_1/South_eastern_perennial/RFE/Modelling/Rpart/pred_vs_ref.csv")
...
write.csv(per_class_metrics_rpart,"D:/Drive_C_2_18_21/PhD_WORK/Chapter_1/South_eastern_perennial/RFE/Modelling/Rpart/per_class_metrics_rpart.csv")
...
write.csv(Macro_averaged_metrics_tree,"D:/Drive_C_2_18_21/PhD_WORK/Chapter_1/South_eastern_perennial/RFE/Modelling/Rpart/macro_averaged_metric_tree.csv")
...
write.csv(pred_vs_ref_rpart_pruned,"D:/Drive_C_2_18_21/PhD_WORK/Chapter_1/South_eastern_perennial/RFE/Modelling/Rpart/pred_vs_ref_pruned.csv")
...
write.csv(per_class_metrics_rpart_pruned,"D:/Drive_C_2_18_21/PhD_WORK/Chapter_1/South_eastern_perennial/RFE/Modelling/Rpart/per_class_metrics_rpart_pruned.csv")
...
write.csv(Macro_averaged_metrics_tree_pruned,"D:/Drive_C_2_18_21/PhD_WORK/Chapter_1/South_eastern_perennial/RFE/Modelling/Rpart/macro_averaged_metric_tree_pruned.csv")
...
tree_boruta$variable.importance
...
p_tree_boruta_train <- predict(tree_boruta,train_boruta,type = "class")

c_tree_boruta_train <- confusionMatrix(p_tree_boruta_train,train_boruta$Species)
...
write.csv(pred_vs_ref_rpart,"D:/Drive_C_2_18_21/PhD_WORK/Chapter_1/South_eastern_perennial/Boruta/Modelling/Rpart/pred_vs_ref.csv")
...
write.csv(per_class_metrics_rpart,"D:/Drive_C_2_18_21/PhD_WORK/Chapter_1/South_eastern_perennial/Boruta/Modelling/Rpart/per_class_metrics_rpart.csv")
...
write.csv(Macro_averaged_metrics_tree,"D:/Drive_C_2_18_21/PhD_WORK/Chapter_1/South_eastern_perennial/Boruta/Modelling/Rpart/macro_averaged_metric_tree.csv")
...
write.csv(pred_vs_ref_rpart_pruned,"D:/Drive_C_2_18_21/PhD_WORK/Chapter_1/South_eastern_perennial/Boruta/Modelling/Rpart/pred_vs_ref_pruned.csv")
...
write.csv(per_class_metrics_rpart_pruned,"D:/Drive_C_2_18_21/PhD_WORK/Chapter_1/South_eastern_perennial/Boruta/Modelling/Rpart/per_class_metrics_rpart_pruned.csv")
...
p_rf_boruta_train <- predict(Rf_boruta,train_boruta)

p_rf_boruta <- predict(Rf_boruta,test_boruta)

c_rf_boruta_train <- confusionMatrix(p_rf_boruta_train,train_boruta$Species)
...
pred_vs_ref_rf_boruta_train <- data.frame(c_rf_boruta_train$table)

### writing this dataframe out in a nice excel sheet ### 

write.csv(pred_vs_ref_rf_boruta_train,"D:/Drive_C_2_18_21/PhD_WORK/Chapter_1/South_eastern_perennial/Boruta/Modelling/Random_forest/pred_vs_ref_train.csv")

######## 

per_class_metrics_RF_boruta_train <- data.frame(c_rf_boruta_train$byClass)

### writing this dataframe out in a nice excel sheet ### 

write.csv(per_class_metrics_RF_boruta_train,"D:/Drive_C_2_18_21/PhD_WORK/Chapter_1/South_eastern_perennial/Boruta/Modelling/Random_forest/per_class_metrics_RF_train.csv")

#### Macro averaged metrics ### Random_forest ########

Macro_averaged_metrics_Rf_train <- data.frame(apply(per_class_metrics_RF_boruta_train[-1],2,mean))

## renaming the column ### 

colnames(Macro_averaged_metrics_Rf_train) ### getting the name of the column 

names(Macro_averaged_metrics_Rf_train)[names(Macro_averaged_metrics_Rf_train) == "apply.per_class_metrics_RF_boruta_train..1...2..mean."] <- "macro_averaged_metrics"

### Write it out in a nice excel sheet ### 

write.csv(Macro_averaged_metrics_Rf_train,"D:/Drive_C_2_18_21/PhD_WORK/Chapter_1/South_eastern_perennial/Boruta/Modelling/Random_forest/macro_averaged_metrics_RF_train.csv")
